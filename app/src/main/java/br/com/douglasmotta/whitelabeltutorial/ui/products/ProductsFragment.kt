...
class ProductsFragment : Fragment() {
    ...
    private fun observeNavBackStack() {
        findNavController().run {
            ...
            val savedInstanceHandle = navBackStackEntry.savedStateHandle
            val observer = LifecycleEventObserver { _ ,event ->
                if(event == Lifecycle.Event.ON_RESUME && savedInstanceHandle.contains(PRODUCT_KEY)) {
                    val product = savedInstanceHandle.get<Product>(PRODUCT_KEY)
                    ...
                    savedInstanceHandle.remove<Product>(PRODUCT_KEY)
                }
            }
    ...
    private fun observeVMEvents() {
        ...
        viewModel.addButtonVisibilityData.observe(viewLifecycleOwner) { visible ->
